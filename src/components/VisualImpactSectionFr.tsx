    ...
    <section className="py-20 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        <h2 className="font-heading text-3xl md:text-4xl mb-12 text-center text-stone-800 w-3/4 mx-auto">
          Offrez à vos clients l'expérience d'un matériau d'exception
        </h2>
        ...
        <div className="mb-12">
          <div className="relative overflow-hidden rounded-3xl shadow-lg">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              <h3 className="font-heading mb-2 text-3xl">La perfection dans les moindres détails</h3>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <div className="relative overflow-hidden rounded-2xl shadow-lg">
              <img 
                ...
                alt="Artisan au travail dans l'atelier Covarte" 
                className="w-full h-[350px] object-cover" 
              />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="font-body text-stone-600 leading-relaxed">
              Faites découvrir nos matériaux à vos clients : voir et toucher les aide à décider plus vite. Demandez vos échantillons gratuits dès maintenant.
            </p>
          </div>
        </div>
...
export default VisualImpactSectionFr;
