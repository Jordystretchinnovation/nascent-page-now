...
interface CTAFormKeuketrendsProps {
  title: string;
}

const CTAFormKeukentrends = ({ title }: CTAFormKeuketrendsProps) => {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    if (!marketingOptin) {
      setMarketingOptinError("Dit is verplicht om de e-guide te kunnen ontvangen.");
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: "Je ontvangt de e-guide binnen enkele minuten per e-mail."
      });
      ...
      setTimeout(() => {
        navigate("/thank-you/keukentrends");
      }, 1000);
  ...
  const getButtonText = () => {
    ...
    return "Download gratis e-guide";
  };
      ...
      <form onSubmit={handleFormSubmit} className="space-y-5">
        ...
        <div className="flex items-start space-x-3 pt-2">
          ...
          <div className="flex-1">
            ...
            >
              Ja, ik wil graag de e-guide ontvangen en blijf graag op de hoogte van producten, aanbiedingen en nieuws van Covarte.
            </Label>
            {marketingOptinError && (
...
export default CTAFormKeukentrends;
