...
const HeroSectionKeuketrendsFr = () => {
  const scrollToForm = () => {
  ...
  return <section className="relative bg-gradient-to-b from-stone-800 to-stone-700 text-white py-32 px-6 overflow-hidden">
      {/* Background Image */}
      ...
      <div className="absolute top-8 left-1/2 transform -translate-x-1/2 z-20">
        <img src="/lovable-uploads/89e030a6-df2f-49fe-8523-9de6dfe82f8b.png" alt="Covarte Logo" className="h-6 md:h-8 w-auto" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center pt-20">
        ...
        <div className="flex justify-center">
          <Button size="lg" className="font-body bg-amber-600 hover:bg-amber-700 text-white text-base py-4 px-8 rounded-lg" onClick={scrollToForm}>Télécharger notre guide</Button>
        </div>
      </div>
    </section>;
};
export default HeroSectionKeuketrendsFr;