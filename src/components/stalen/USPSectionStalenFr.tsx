      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-stone-50 p-8 rounded-2xl border border-stone-100 hover:shadow-lg transition-shadow">
            ...
            <p className="font-body text-stone-600 leading-relaxed">20.000m2 prêts à soutenir votre croissance </p>
          </div>
        </div>
      </div>
    </section>;
};
export default USPSectionStalenFr;