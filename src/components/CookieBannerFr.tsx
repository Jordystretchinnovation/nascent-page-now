      ...
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex-1">
          <p className="text-sm text-stone-700 leading-relaxed mb-2">
            Nous utilisons des cookies pour améliorer votre expérience et à des fins marketing. 
            En cliquant sur "Accepter", vous consentez à l'utilisation de tous les cookies. 
            Vous pouvez toujours modifier vos préférences dans les paramètres.
          </p>
          <Link 
            to="/fr/politique-cookies" 
