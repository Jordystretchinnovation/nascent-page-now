...
const CTAForm = ({ type, title }: CTAFormProps) => {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { data, error } = await supabase.from("form_submissions_2026").insert([submissionData]).select();
  ...
  return (
    <DialogContent className="sm:max-w-md bg-white">
      ...
      <form name="TestFormulier - CTAFORM" onSubmit={handleFormSubmit} className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <Label htmlFor="voornaam" className="text-stone-700 font-medium">
              Voornaam *
            </Label>
            <Input
              id="voornaam"
          ...
          <div>
            <Label htmlFor="achternaam" className="text-stone-700 font-medium">
              Achternaam *
            </Label>
            <Input
              id="achternaam"
        ...
        <div>
          <Label htmlFor="bedrijf" className="text-stone-700 font-medium">
            Bedrijf *
          </Label>
          <Input
            id="bedrijf"
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <Label htmlFor="telefoon" className="text-stone-700 font-medium">
              Telefoon *
            </Label>
            <Input
              id="telefoon"
              ...
              className="mt-1 border-stone-200 focus:border-stone-400 focus:ring-stone-400"
              required={
                type === "stalen" || type === "korting" || (type === "renderboek" && renderbookType === "fysiek")
              }
              disabled={isSubmitting}
            />
          </div>
        ...
        {type === "renderboek" && (
          <>
            <div>
              ...
              <RadioGroup
                value={renderbookType}
                onValueChange={setRenderbookType}
                className="mt-2"
                disabled={isSubmitting}
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="digitaal" id="digitaal" />
                  <Label htmlFor="digitaal" className="text-stone-700">
                    Digitaal
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="fysiek" id="fysiek" />
                  <Label htmlFor="fysiek" className="text-stone-700">
                    Fysiek
                  </Label>
                </div>
              </RadioGroup>
        ...
        {(type === "stalen" || (type === "renderboek" && renderbookType === "fysiek")) && (
          <>
            <div>
              <Label htmlFor="straat" className="text-stone-700 font-medium">
                Straat + nr *
              </Label>
              <Input
                id="straat"
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <Label htmlFor="postcode" className="text-stone-700 font-medium">
                  Postcode *
                </Label>
                <Input
                  id="postcode"
              ...
              <div>
                <Label htmlFor="gemeente" className="text-stone-700 font-medium">
                  Gemeente *
                </Label>
                <Input
                  id="gemeente"
        ...
        <div className="flex items-start space-x-3 pt-2">
          ...
          <div className="flex-1">
            <Label htmlFor="marketing-optin" className="text-sm text-stone-600 leading-relaxed cursor-pointer">
              {getMarketingOptinText()}
            </Label>
            {marketingOptinError && <p className="text-red-600 text-sm mt-1">{marketingOptinError}</p>}
          </div>
        </div>
