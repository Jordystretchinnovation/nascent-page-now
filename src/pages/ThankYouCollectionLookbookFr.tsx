  ...
  return <div className="min-h-screen bg-stone-50 flex items-center justify-center px-6">
      <div className="max-w-md w-full text-center">
        <div className="bg-white p-8 rounded-2xl border border-stone-200 shadow-sm">
          ...
          <h1 className="text-2xl font-light text-stone-800 mb-4">Merci ! Votre Collection Lookbook est en route !</h1>
          <p className="text-stone-600 mb-6 leading-relaxed">
            Nous avons reçu votre demande pour le Collection Lookbook. Vous le recevrez dans quelques minutes par e-mail.
          </p>
