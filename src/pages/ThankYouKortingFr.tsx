      ...
      <div className="max-w-md w-full text-center">
        <div className="bg-white p-8 rounded-2xl border border-stone-200 shadow-sm">
          ...
          <h1 className="text-2xl font-light text-stone-800 mb-4">
            Génial ! Votre réduction est en route !
          </h1>
          <p className="text-stone-600 mb-6 leading-relaxed">Nous avons reçu votre demande pour 50% de réduction. Nous vous contacterons dans les 24 heures pour discuter de votre projet et activer votre réduction.</p>
...
export default ThankYouKortingFr;